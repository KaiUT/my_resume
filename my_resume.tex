...
\begin{rSection}{Profile}
  Ph.D. in Computational Biology (expected December 2018). Solid skills in
  machine learning, statistical inference. Comprehensive computing skills
  including Python, R, SQL, Hadoop, Spark, TensorFlow. Excellent problem solving skills in
  both independent and team environments. Skilled presenter of technical
  materials to both technical and non-technical audiences. Quick, thorough and
  effective learner.
\end{rSection}
...
Texas at Austin, Austin, TX} \hfill {Expected December 2018} \\
% \vspace{0.3em}\\
...
\begin{rSection}{Work Experience}
  ...
  \item Built up data pipeline to automate the process of retrieving and
    cleaning data from CDC, BSVE, Google Trends, Wikipedia, Twitter etc;
...
\begin{tabular}{ @{} >{\bfseries}l @{\hspace{6ex}} l }
  ...
  models {$\cdot$} Frequent Pattern Mining \\
\end{tabular}
\end{rSection}
